"""
Language selection module following the utility class pattern.
"""
import gi
...
class Language:
    ...
    def language_selection(cls, tree_selection: Gtk.TreeSelection) -> None:
        ...
        class variables and SetupData with the language name and code.
        ...
        if treeiter is not None:
            ...
            SetupData.language = value
            SetupData.language_code = language_code
    ...
    def initialize(cls) -> None:
        ...
        - Welcome message and language selection tree view on the right side
        ...
        # Right side - Welcome content and language selection
